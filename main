...
# Game over text
over_font1 = pygame.font.Font('freesansbold.ttf', 48)
...
def game_over_text():
    ...
    over_score = over_font2.render("Score:" + str(score_value), True, (255, 255, 255))
    screen.blit(over_text, (200, 250))
    screen.blit(over_score, (200, 300))
...
while running:
    ...
    # Checking for boundaries so that spaceship anything doesnt go out of bounds
